...
$riwayatTransaksi = $transaksi->riwayat();
...
<body>
    ...
    <p>
        <a href="TampilTransaksi.php">Kembali ke Transaksi</a>
    </p>
    ...
    <table border="1" cellpadding="8">
        ...
        <tbody>
            ...
            <?php foreach ($riwayatTransaksi as $dataTransaksi): ?>

                <tr>
                    <td><?= $dataTransaksi['id'] ?></td>

                    <td><?= $dataTransaksi['nama_pelanggan'] ?></td>

                    <td><?= $dataTransaksi['pilihan_layanan'] ?></td>
